...
# 1_limit 		- starts with a number

#Poor variable names
# limit_46246141346 	- complicated
# Limit 		- Starts with a capital letter
# LIMIT 		- In capitals (though not so bad if used as a constant
# s 			- Not descriptive
# _limit 		- Starts with an underscore
